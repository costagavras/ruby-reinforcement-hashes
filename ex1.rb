...
ar_wheelchair_accessible_venues = []
ar_wheelchair_accessible_venues = venues.select do |venues|
                            venues[:city] == "Toronto" && venues[:wheelchair_accessible] == true && venues[:capacity] > 150
                            end

puts ar_wheelchair_accessible_venues
